...
<html id="html">
<head>
	<title>Invitation for <?php echo APPNAME; ?></title>
	...
	<style type="text/css">
		...
		#logo {
		    ...
		    letter-spacing: -4px;
		    line-height: 57px;
		    margin: 27px -16px -3px !important;
		    padding: 10px 0;
		}
		...
		<div id="pageAccountInfo" style="padding-bottom:20px;">
			<div class="ui grid header-top">
	            ...
	            <div class="ui twelve wide column aligned left">
	            	...
	            	<h2 class="stepOne elements">Sign Up</h2>
					<p id="p_info" class="stepOne elements">To get started, please enter your email address. We will send a signup invitation to you.</p>
					<div class="stepOne elements" style="height:6px;"></div>

					<!-- email -->
					<div class="ui form segment" style="display:nones;">
						<h2 class="_segment_header stepOne elements">Invite</h2>
						<div class="field stepOne elements">
							<label>Email Address</label>
							<input type="text" placeholder="Your email address" id="email">
						</div>
						<div class="ui blue small button stepOne elements" id="btn_create_invite">Send Invitation</div>
						<div id="stepTwo" class="field stepTwo elements">
							<h2 class="_segment_header stepTwo elements">Are You A Person?</h2>
							<p>Here's a fun little game that helps us be sure you are a real person ;-)  Please click on the item below that is <strong style="color:red;">not</strong> food.</p>
							<div id="humanTest" class="ui tiny images"></div>
						</div>
						<h2 class="_segment_header stepThree elements">Thank You</h2>
						<div class="field stepThree elements">
							<p>Your invitation has been sent to: <span id="myEmail"></span></p>
						</div>
					</div>
