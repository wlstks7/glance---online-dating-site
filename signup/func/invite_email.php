...
//test if this user has posted more than 3 times today
if ( checkUserSubmission($ip) > 3) {
    ...
    $response = array(
      ...
      'status' => 'fail', 
      'error' => 'true', 
      'msg' => "I'm sorry, you can only sign up 3 email addresses per day.", 
      'results' => 'none'
    );
...
if ( checkEmailAccountInvite($email_address) > 0) {
    ...
    $response = array(
      ...
      'status' => 'fail', 
      'error' => 'true', 
      'msg' => "I'm sorry, an invite was sent to this email address. Please be sure to check your SPAM folder. If you haven't received it in 3 hours, please try again.", 
      'results' => 'none'
    );
...
if ( checkEmailAccount($email_address) != 0) {
    ...
    $response = array(
      ...
      'status' => 'fail', 
      'error' => 'true', 
      'msg' => "I'm sorry, this email is associated with another account.", 
      'results' => 'none'
    );
...
$params = array(
    ...
    'to'        => $email_address,
    'subject'   => APPNAME . ' - Welcome Invitation',
    'html'      => $html,
    'text'      => 'Welcome to ' . APPNAME . '! This looks so much better with HTML enabled.'
  );
...
function getHTML($seed){
  ...
  <title>$app_name - Welcome Invitation</title>
  <style type="text/css">
  /* -------------------------------------
      GLOBAL
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="content-block">
                      <p><img alt="" src="https://images.glancedate.com/logo_glance.png" width="230" style="-ms-interpolation-mode: bicubic;border: 0;height: auto;line-height: 100%;outline: none;text-decoration: none;"></p>
                    </td>
                  </tr>
                  <tr>
                    <td class="content-block">
                      <h1>Invitation</h1>
                      <p>Welcome to $app_name! Click the button below to setup your new account</a></p>
                    </td>
                  </tr>
                  <tr>
                    <td class="content-block" itemprop="handler" itemscope itemtype="http://schema.org/HttpActionHandler">
                      <a href="$site_url/signup/account-setup.php?q=$seed" class="btn-primary" itemprop="url">Confirm email address</a>
                    </td>
                  </tr>
                </table>
              </td>
