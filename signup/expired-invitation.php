...
<html id="html">
<head>
	<title><?php echo APPNAME; ?> - Expired Invitation</title>
...
<body class="pushable">
	...
	<div id="loading" style="font-family: arial; font-weight: 100; background: #1EA8FF; width: 100%; height: 2000px;">
		...
		<div id="pageAccountInfo" style="padding-bottom:20px;">
			<div class="ui grid header-top">
	            ...
	            <div class="ui twelve wide column aligned left">
	            	...
	            	<h2 class="_segment_header">Invitation Expired</h2>
	            	<p>I'm sorry, this invitation has expired. </p>
	            	<p><a href="./invitation/">Click here to try your email address again</a></p>
	            </div>
