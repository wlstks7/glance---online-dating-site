		...
		<div id="pageAccountInfo" style="padding-bottom:20px;">
			<div class="ui grid header-top">
	            ...
	            <div class="ui twelve wide column aligned left">
	            	...
	            	<h2 class="_segment_header">Username Not Available</h2>
	            	<p>I'm sorry, this email address is associated with another account. </p>
	            	<p><a href="./invitation/">Click here to try another email address</a></p>
	            </div>
