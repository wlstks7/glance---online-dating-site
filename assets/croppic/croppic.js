...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		createCropControls: function(){
			...
			var cropControlZoomIn =          '<i title="Zoom In" class="cropControlZoomIn"></i>';
			var cropControlZoomOut =         '<i title="Zoom Out" class="cropControlZoomOut"></i>';
			var cropControlZoomMuchOut =     '';
			var cropControlRotateLeft =      '';
	        var cropControlRotateRight =     '';
	        var cropControlCrop =            '<i title="Crop this image and save" class="cropControlCrop"></i>';
			var cropControlReset =           '<i title="Reset the image and start over" class="cropControlReset"></i>';
			...
			if(that.options.rotateControls){
				cropControlRotateLeft = '<i title="Rotate the image left" class="cropControlRotateLeft"></i>';
				cropControlRotateRight = '<i title="Rotate the image right" class="cropControlRotateRight"></i>';
			}
